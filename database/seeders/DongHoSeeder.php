    ...
    public function run(): void
    {
        DB::table('dong_hos')->insert([
           [
                ...
                'gia_huan' => 'Giữ nếp nhà, trọng hiếu nghĩa, khuyến học và tương trợ con cháu.',
                'loi_gioi_thieu' => 'Gia phả ghi lại cội nguồn, các đời nối tiếp và những dấu mốc quan trọng của dòng họ Nguyễn Bá.',
                'dia_chi_tu_duong' => 'Bắc Ninh',
                'theme_color' => 'gold',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'gia_huan' => 'Lấy đức làm gốc, lấy học làm đường, lấy hòa thuận làm nền.',
                'loi_gioi_thieu' => 'Không gian lưu giữ thông tin thành viên, sự kiện, tài liệu và mộ phần của dòng họ Trần Văn.',
                'dia_chi_tu_duong' => 'Nam Định',
                'theme_color' => 'jade',
                'created_at' => now(),
                'updated_at' => now(),
            ],
