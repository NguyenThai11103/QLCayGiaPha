...
import { spacing, fontSize, borderRadius, colors, rs, rvs, rf, screen } from '../config/theme';
...
const ProfileScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const ACTIONS = [
    ...
    { icon: 'lock-closed-outline',   label: 'Đổi mật khẩu',   color: '#A78BFA', onPress: () => navigation.getParent()?.navigate('ChangePassword') },
    { icon: 'documents-outline',     label: 'Tài liệu gia tộc',color: '#3B82F6', onPress: () => navigation.getParent()?.navigate('TaiLieu') },
...
const s = StyleSheet.create({
  ...
  scroll: { paddingBottom: rvs(20) },
  screenLabel: {
    textAlign: 'center', fontSize: rf(10), fontWeight: '800',
    letterSpacing: 2.5,
  ...
  avatarRing: { width: rs(110), height: rs(110), borderRadius: rs(55), padding: rs(3), justifyContent: 'center', alignItems: 'center' },
  avatarInner: { width: rs(104), height: rs(104), borderRadius: rs(52), justifyContent: 'center', alignItems: 'center' },
  avatarTxt: { fontSize: rf(42), fontWeight: '900' },
  onlineDot: { position: 'absolute', bottom: rs(30), right: 0, width: rs(22), height: rs(22), borderRadius: rs(11), justifyContent: 'center', alignItems: 'center' },
  onlineDotInner: { width: rs(14), height: rs(14), borderRadius: rs(7), backgroundColor: '#10B981' },
  roleBadge: { flexDirection: 'row', alignItems: 'center', gap: rs(5), paddingHorizontal: rs(12), paddingVertical: rs(5), borderRadius: 50, borderWidth: 1, marginTop: rs(10) },
  roleText: { fontSize: rf(11), fontWeight: '700' },
  name: { fontSize: rf(26), fontWeight: '900', letterSpacing: -0.5, textAlign: 'center' },
  email: { fontSize: rf(13), marginTop: rs(4), marginBottom: rs(4) },

  section: { paddingHorizontal: spacing.lg, marginTop: spacing.xl },
  sectionTitle: { fontSize: rf(10), fontWeight: '800', letterSpacing: 2, marginBottom: spacing.sm },
  card: { borderRadius: rs(20), borderWidth: 1, overflow: 'hidden' },
  separator: { height: 1, marginLeft: rs(66) },

  logoutBtn: { marginHorizontal: spacing.lg, marginTop: spacing.xl, borderRadius: rs(18), overflow: 'hidden', borderWidth: 1 },
  logoutGrad: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: rs(10), paddingVertical: rvs(16), borderRadius: rs(18) },
  logoutText: { fontSize: rf(16), fontWeight: '800', color: '#EF4444', letterSpacing: 0.3 },
  version: { textAlign: 'center', fontSize: rf(11), marginTop: spacing.xl, fontWeight: '500' },
});

const mi = StyleSheet.create({
  row: { flexDirection: 'row', alignItems: 'center', padding: spacing.md, gap: spacing.md },
  iconBox: { width: rs(40), height: rs(40), borderRadius: rs(12), justifyContent: 'center', alignItems: 'center', flexShrink: 0 },
  content: { flex: 1 },
  label: { fontSize: rf(14), fontWeight: '600' },
  value: { fontSize: rf(12), marginTop: rs(2), fontWeight: '500' },
});
