    ...
    public function run(): void
    {
        ...
        DB::table('su_kiens')->insert([
            ...
            [
                'dong_ho_id' => 1,
                'thanh_vien_id' => 2,
                'ten_su_kien' => 'Mừng thọ Cụ Nguyễn Bá Tuấn',
                'mo_ta' => 'Lễ mừng thọ thượng thọ cụ 90 tuổi',
                'ngay_duong' => $now->copy()->addMonths(1)->format('Y-m-d'),
                'ngay_am' => $now->copy()->addMonths(1)->subMonths(1)->format('Y-m-d'),
                'dia_diem' => 'Nhà văn hóa xã',
                'loai_su_kien' => 'mung_tho',
            ...
            [
                'dong_ho_id' => 2,
                'thanh_vien_id' => null,
                'ten_su_kien' => 'Lễ cưới chú Trần Lê Minh',
                'mo_ta' => 'Lễ thành hôn',
                'ngay_duong' => $now->copy()->addMonths(3)->format('Y-m-d'),
                'ngay_am' => null,
                'dia_diem' => 'Trung tâm tiệc cưới Trống Đồng',
                'loai_su_kien' => 'le_cuoi',
                'lap_lai_hang_nam' => false,
                'created_at' => now(), 'updated_at' => now(),
            ],
        ]);
